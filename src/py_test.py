...
df=test('data/init_data.csv',col_sum_1,col_sum_2,col_make_sum,col_make_date=col_make_date)
...
model_fitted=model_maker(model,'Linear_reg',df,'V0_py_test',param_grid,'Velib',flg_first=True)[0]
print(model_fitted.predict(make_future(df,'DAY OF WEEK',to_fit)))